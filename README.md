...
One analysis costs **0.25 USDC**, or **250000 atomic units**, on **Base mainnet (`eip155:8453`)**. This is real money, not testnet credit. Inspect the current live challenge before approving a purchase; third-party wallet/provider charges, if any, are separate.
...
**Verification limit:** the free MCP connection, fixture, and unpaid challenge are verified by this example. A fresh real-money settlement through MCP has not been verified here. This repository deliberately contains no paying MCP implementation.
